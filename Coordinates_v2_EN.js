...
// 2. Drag & Drop for the main window
let vx, vy, dx, dy;
...
// 5. Smart Cropping Tool
window.cropBtn.click(() => {
    isScanning = false;

    // Hide the main window to keep it out of the screenshot
    window.setPosition(-2000, -2000);

    // ✅ setTimeout instead of sleep() — avoids blocking the UI thread
    setTimeout(() => {
    ...
    }, 400); // Wait 400ms for window to fully hide before screenshot
});
